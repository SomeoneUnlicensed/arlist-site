  ...
  return <SiteShell>
    ...
    <section className="mx-auto max-w-[1540px] px-5 pb-32 sm:px-8 lg:px-12">
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <Panel><h2 className="text-3xl font-semibold tracking-[-0.05em]">Калькулятор узлов</h2><p className="mt-5 max-w-xl leading-7 text-[#171817]/62">Классификация узлов по числу пересечений, перенесённая на любую размерность: что играет роль перекрёстка для сферы Sⁿ в Sⁿ⁺², сколько таких узлов перечислено и где таблицы обрываются.</p><div className="mt-8"><Link to="/knots" className="inline-flex items-center gap-2 border-b border-[#171817]/25 pb-1 font-mono text-[10px] uppercase tracking-[0.16em] hover:border-[#171817]">Посчитать узлы →</Link></div></Panel>
      </div>
